...
try
{
	Class.forName("com.mysql.jdbc.Driver");
 	...
 	PreparedStatement ps=con.prepareStatement("insert into car_info(name, brand, type, price, mileage, no_of_door, seat_cap, wheel_type, steering_type, airbags, passenger_abags, speakers, usb_support, radio_support, bluetooth_sup, gps_navigation, rear_ac, ac, price_range, image) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
